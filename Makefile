...
OBJSL		= $(BINARY).o hwinit.o stm32scheduler.o params.o terminal.o terminal_prj.o \
           ...
           chademo.o amperaheater.o amperacharger.o subaruvehicle.o iomatrix.o bmw_sbox.o NissanPDM.o pdmchademo.o teslaCharger.o extCharger.o vag_sbox.o \
		   ...
		   stwmbms.o oibms.o WebastoHVH.o InverterACP.o Maintainer12V.o PKP2300_Lever.o C5Charger.o C5DCDC.o
